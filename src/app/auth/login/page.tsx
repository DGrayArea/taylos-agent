  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#07080d] px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      >
        ...
        <form className="space-y-4 relative" action={login}>
          {/* Email input */}
        ...
        <div className="mt-5 text-center text-xs text-gray-400 relative">
          ...
          <Link href="/auth/signup" className="text-[var(--color-gold-light)] hover:text-white font-semibold transition-colors">
            Sign up free
          </Link>
        </div>
      </motion.div>
