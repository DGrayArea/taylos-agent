...
export default async function LoginPage({
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--color-background)] px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 -mr-40 -mt-40 w-[600px] h-[600px] rounded-full bg-[var(--color-accent)]/10 blur-[120px]" />
      ...
      <div className="w-full max-w-md relative z-10 bg-[var(--color-surface)] border border-white/10 rounded-3xl shadow-2xl p-8">
        ...
        <p className="mt-2 text-center text-sm text-gray-400">
          Enter your details below or use Google to sign in
        </p>
        ...
        <div className="mt-8">
          ...
          <div className="mt-8 text-center text-sm text-gray-400">
            ...
            <Link href="/auth/signup" className="text-[var(--color-gold-light)] hover:text-white font-medium transition-colors">
              Sign up
            </Link>
          </div>
        </div>
